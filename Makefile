...
minish: minish.o linea2argv.o builtin_getenv.o temp.o ejecutar.o externo.o builtin_lookup.o builtin_cd.o builtin_pid.o builtin_gid.o builtin_uid.o builtin_setenv.o builtin_unsetenv.o builtin_exit.o builtin_help.o builtin_status.o builtin_history.o wrappers.o
